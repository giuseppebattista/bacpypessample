...
from CommunicationsCore import ApplicationServiceElement, Bind
...
from ApplicationService import StateMachineAccessPoint, ApplicationServiceAccessPoint
from NetworkService import NetworkServiceAccessPoint, NetworkServiceElement
from BVLL import BIPSimple, BIPForeign, AnnexJCodec, UDPMultiplexer
...
class Application(ApplicationServiceElement, Logging):
    ...
    def __init__(self, localDevice, localAddress, aseID=None):
        Application._debug("__init__ %r %r aseID=%r", localDevice, localAddress, aseID)
    ...
    def AddObject(self, obj):
        ...
        Application._debug("AddObject %r", obj)
    ...
    def DeleteObject(self, obj):
        """Add an object to the local collection."""
        Application._debug("DeleteObject %r", obj)
    ...
    def do_WhoIsRequest(self, apdu):
        ...
        Application._debug("do_WhoIsRequest %r", apdu)
    ...
    def do_IAmRequest(self, apdu):
        ...
        Application._debug("do_IAmRequest %r", apdu)
    ...
    def do_ReadPropertyRequest(self, apdu):
        ...
        Application._debug("do_ReadPropertyRequest %r", apdu)
        
        # get the object
        obj = self.GetObjectID(apdu.objectIdentifier)
        Application._debug("    - object: %r", obj)
        ...
        if not obj:
            ...
            try:
                ...
                Application._debug("    - datatype: %r", datatype)
                
                # get the value
                value = obj.ReadProperty(apdu.propertyIdentifier, apdu.propertyArrayIndex)
                Application._debug("    - value: %r", value)
    ...
    def do_WritePropertyRequest(self, apdu):
        ...
        Application._debug("do_WritePropertyRequest %r", apdu)
        ...
        if not obj:
            ...
            try:
                ...
                if issubclass(datatype, Array) and (apdu.propertyArrayIndex is not None):
                    if apdu.propertyArrayIndex == 0:
                        value = resp.propertyValue.CastOut(Unsigned)
                    else:
...
class BIPSimpleApplication(Application, Logging):
    ...
    def __init__(self, localDevice, localAddress, aseID=None):
        BIPSimpleApplication._debug("__init__ %r %r aseID=%r", localDevice, localAddress, aseID)
...
class BIPForeignApplication(Application, Logging):
    ...
    def __init__(self, localDevice, localAddress, bbmdAddress, bbmdTTL, aseID=None):
        BIPForeignApplication._debug("__init__ %r %r %r %r aseID=%r", localDevice, localAddress, bbmdAddress, bbmdTTL, aseID)
        Application.__init__(self, localDevice, localAddress, aseID)
