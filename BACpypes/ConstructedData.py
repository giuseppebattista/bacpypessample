...
def SequenceOf(klass):
    ...
    global _SequenceOfClasses, _ArrayOfClasses
    ...
    if _ArrayOfClasses.has_key(klass):
...
def ArrayOf(klass):
    ...
    some other type."""
    global _ArrayOfMap
    global _ArrayOfClasses, _SequenceOfClasses

    # if this has already been built, return the cached one
    if _ArrayOfMap.has_key(klass):
        return _ArrayOfMap[klass]
    ...
    # cache this type
    _ArrayOfMap[klass] = ArrayOf
    _ArrayOfClasses[ArrayOf] = 1
